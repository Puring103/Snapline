...
import { ArrowUp, Bot, FileText, KeyRound, Sparkles, X } from 'lucide-react';

export function AiPanel({ configured, onClose }: { configured: boolean; onClose: () => void }) {
