import { Archive, ArchiveRestore, AudioLines, Camera, FileText, Image, MoreHorizontal, Pin, PinOff, Search, SlidersHorizontal, Trash2, Video } from 'lucide-react';
